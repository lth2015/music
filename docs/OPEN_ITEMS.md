...
| **Colour contrast measurement** (UI-14) | The palette is the specified one, but 4.5:1 has not been **measured**. `--text-muted #A9AFBE` on `--panel #1A1C22` is the case to check first. | Small |
